...
<ul class="slides">
  ...
  <?php } else { ?>
    <img src="<?php print base_path() . drupal_get_path('theme', 'flowerjoiner') . '/_custom/sliderimg/slide-1.jpg'; ?>" class="slide-image" alt="<?php print $slide1_alt; ?>" /></a>
  <?php } ?>
    <div class="clearfix"></div>
    </div>
  </li>
  ...
  <?php } else { ?>
    <img src="<?php print base_path() . drupal_get_path('theme', 'flowerjoiner') . '/_custom/sliderimg/slide-2.jpg'; ?>" class="slide-image" alt="<?php print $slide2_alt; ?>" /></a>
  <?php } ?>
    <div class="clearfix"></div>
    </div>
  </li>
  ...
  <?php } else { ?>
    <img src="<?php print base_path() . drupal_get_path('theme', 'flowerjoiner') . '/_custom/sliderimg/slide-3.jpg'; ?>" class="slide-image" alt="<?php print $slide3_alt; ?>" /></a>
  <?php } ?>
    <div class="clearfix"></div>
    </div>
  </li>
