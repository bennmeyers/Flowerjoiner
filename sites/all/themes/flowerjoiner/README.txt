README.TXT // Flowerjoiner responsive theme for Drupal 7.

Thank you for downloading this theme!


ABOUT THE FLOWERJOINER THEME:
-------------------------------------------------------------------------+
Flowerjoiner is an advanced responsive, "mobile first", HTML5 theme with layout 
...
To know more, read Flowerjoiner handbook (http://drupal.org/node/507792).
...
-------------------------------------------------------------------------+
1) Place the flowerjoiner directory into your themes directory (sites/all/themes/flowerjoiner).
2) Enable the Flowerjoiner theme (/admin/appearance).
3) You can configure the theme's settings at /admin/appearance/settings/flowerjoiner. 


UPGRADING to a new version of Flowerjoiner
-------------------------------------------------------------------------+
1. If possible, log on as administrator user. 
2. Put the site in "Off-line" mode.
3. Check "Rebuild theme registry on every page" at /admin/appearance/settings/flowerjoiner
4. Place the flowerjoiner directory into your themes directory (sites/all/themes/flowerjoiner).
...
6. Put the site in "On-line" mode. It is always a good idea to refresh the browser's 
   cache (CTRL+F5).
7. Check the theme's settings at /admin/appearance/settings/flowerjoiner. Remember 
...
you should delete all the flowerjoiner records in the data base.
...
Various implementations of Flowerjoiner theme can be found here:
