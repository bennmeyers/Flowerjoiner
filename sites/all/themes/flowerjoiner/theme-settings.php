 ...
 */
function flowerjoiner_form_system_theme_settings_alter(&$form, &$form_state) {
...
// Development settings
  ...
  $form['tnt_container']['themedev']['siteid'] = array(
    ...
    '#title' => t('Site ID bodyclass.'),
   	'#description' => t('In order to have different styles of Flowerjoiner in a multisite/multi-theme environment you may find usefull to choose an "ID" and customize the look of each site/theme in custom-style.css file.'),
