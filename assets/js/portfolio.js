$(document).ready(function(){
	jQuery.get("/assets/xml/projects.xml",{},function(xml) { // insert projects
		$('professional project',xml).each(function() { // insert professional projects
			...
			var lsProject = '<div class="col-sm-4"><p><a href="/assets/img/samples/full/' + lsThumb + '.jpg" title="' + lsSection + '" class="lightbox" target="_blank"><img src="/assets/img/samples/preview/' + lsThumb + '.png" alt="' + lsSection + '" /></a></p><p class="description"><strong><a href="' + lsLink + '" title="' + lsWebsite + '" rel="external">' + lsWebsite + '</a> ' + lsSection + '</strong> '; // define the Local String for the Project
