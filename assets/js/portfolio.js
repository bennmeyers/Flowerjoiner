$(document).ready(function(){
	jQuery.get("/assets/xml/projects.xml",{},function(xml) { // insert projects
		$('professional project',xml).each(function() { // insert professional projects
			...
			var lsProject = '<figure class="col-sm-4" id="' + lsThumb + '"><p><a href="/assets/img/samples/full/' + lsThumb + '.jpg" title="' + lsWebsite + '" class="lightbox" target="_blank"><img src="/assets/img/samples/preview/' + lsThumb + '.png" alt="' + lsWebsite + '" /></a></p><figcaption class="description"><strong><a href="' + lsLink + '" title="' + lsWebsite + '" rel="external">' + lsWebsite + '</a> ' + lsSection + '</strong> '; // define the Local String for the Project
